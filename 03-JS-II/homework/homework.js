...
function esDiezOCinco(numero) {
  ...
  /* 
  // Otra forma sin el else, ya que siempre daria falso
  if (numero === 10 || numero === 5){
    return true;
  }
  return false;
  
  // Otra forma con booleano
...
function fizzBuzz(numero) {
  ...
  /*
  // Se pueden hacer los ifs separados tambien, y dejar el return suelto
  function fizzBuzz(numero) {
    if (numero % 3 === 0 && numero % 5 === 0) {
      return "fizzbuzz";
    }
...
function tieneTresDigitos(numero) {
  ...
  /*
  //Falla con los negativos
  if (numero.toString().length >= 3) {
    return true;
  } else { return false }
  
  //Ah, solo tiene que tener 3 dígitos
